...
module.exports = function login () {
  ...
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    // Use parameterized ORM query to prevent SQL injection
    UserModel.findOne({
      where: {
      ...
      .then((authenticatedUser: { data: User } | any) => { // vuln-code-snippet neutral-line loginAdminChallenge loginBenderChallenge loginJimChallenge
